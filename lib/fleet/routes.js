...
function fleetRoutes(fleetP, cfg = {}) {
  ...
  // Prova di un modello sull'API del suo profilo. NON e' nell'allowlist
  // federata di proposito: consuma la credenziale di QUESTA installazione, e
  // un peer non deve poterla spendere. Non e' gated da READONLY per la stessa
  // ragione di `nodes test`: e' una diagnosi, non una mutazione.
