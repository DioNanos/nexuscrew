...
function createLeaseManager(cfg = {}, seams = {}) {
  ...
  function handleReconnect(cellId, socket, msg) {
    ...
    // bound di grace persistito: se noto e la richiesta arriva ALLA deadline o oltre,
    // rifiuta (>= allineato alla transizione pura cell-lease.js:76, non >: alla
    // deadline esatta la grace e' gia scaduta). Senza bound noto (cella live mai
    // graced) si apre un lease nuovo (recovery post-restart con supervisore/child vivi).
