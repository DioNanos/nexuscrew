...
function createLeaseManager(cfg = {}, seams = {}) {
  ...
  function handleGeneration(cellId, entry, socket, msg) {
    ...
    // L'avanzamento PRIMA dell'ACK e' voluto (at-least-once): se l'ACK si
    // perde, il client ritenta con la STESSA generazione e qui e' idempotente
    // (== corrente -> ACK). L'ordine inverso lascerebbe il server stantio con
    // un client che crede di aver transizionato.
