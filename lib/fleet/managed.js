...
// plan), mai passato per normalizeManagedSpec/extraModels — un caso diverso,
// non toccato dal difetto D2. declaredModels, quando presente, ha priorita'.
function writePiProviderExtension(spec, home, declaredModels) {
  ...
  const definition = {
    ...
    authHeader: true,
    api: spec.protocol,
    models: (Array.isArray(declaredModels) && declaredModels.length ? declaredModels
