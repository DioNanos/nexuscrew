...
async function nodesTestAll(opts) {
  ...
  if (declaredNotProven.length) {
    ...
    log('nodes test: "Share attivo" e\' lo stato desiderato, non una verifica. Un dispositivo spento finisce qui; se e\' acceso, controlla i permitlisten del suo pool.');
  }
