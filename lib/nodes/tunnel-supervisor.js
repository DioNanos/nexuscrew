...
// da revisione — contratto per la sonda del canale -L quando non conclude MAI:
...
// che una revisione ha tolto, solo con una bandiera "non verificato" appesa sopra).
...
//
// da revisione: connect NON è prova di canale. OpenSSH accetta la TCP sul listener
...
// da revisione punto 3: chi ha installato la chiave quando il pannello non esisteva è
...
// secondo difetto della stessa famiglia (da revisione interna):
...
// per sempre. Misurato in revisione: due fake-ssh vivi dopo un degraded,
...
// Esportate per prova diretta (da revisione): il main resta argv/env-driven e NON parte
// al require.
