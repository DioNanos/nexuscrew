...
function loadConfig(opts = {}) {
  const merged = { ...baseDefaults(), ...readConfigJson(), ...envOverrides(), ...opts };
...
module.exports = { assertLoopback, baseDefaults, readConfigJson, loadConfig, defaults, LOOPBACK, configJsonPath, eventsEnabledFlag, readFederationEventsEnabled };
