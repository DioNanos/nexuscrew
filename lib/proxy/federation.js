...
function peerRouter({ nodesPath, localPort, localCredential, fetchImpl, readonly = () => false, version = null, roles = null, hopSecret = null }) {
  ...
  r.get('/reverse-status', async (req, res) => {
    ...
    const health = await probeHealth({
      port: req.peer.localPort, token: req.peer.token,
...
module.exports = {
  ...
  probeHealth, waitForHealthyPeer, canListenLoopback, preflightHubReverse, notifyHubShare, reconcilePeerShare, runShareRevokeBoot,
};
